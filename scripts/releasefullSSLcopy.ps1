...
$source = "C:\CodeSandbox\FullSSL\TitanVision_fullSSL\VisionCommon\bin\Release\VisionCommon.dll",
"C:\CodeSandbox\FullSSL\TitanVision_fullSSL\remotinglayer\commstypes\bin\Release\CommsTypes.dll"
